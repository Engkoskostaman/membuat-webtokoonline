            ...
            <div class="carousel-inner">
              ...
              <div class="item">
                <div class="col-sm-6">
                  ...
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                  <button type="button" class="btn btn-default get">ORDER</button>
                </div>
                <div class="col-sm-6">
              ...
              <div class="item">
                <div class="col-sm-12">
                  <div class="carousel-item active">
                    <img src="/BahanStudy/images/banner1.png" class="d-block w-100" alt="..." width="1000"height="400">
                  </div>
            ...
            <div class="product-image-wrapper">
              <div class="single-products">
                <div class="productinfo text-center">
                  ...
                  <h2> Rp <?php echo number_format($brg->harga) ?></h2>
                  <p>{{$brg->nama_produk}}</p>
                  <?php if($id |= null ){?>
